# -*- coding: utf-8 -*-
"""
Created on Thu Apr  4 12:12:09 2019
...
class PythonObjectLibrary:
    ...
    #_reg_clsctx_ = pythoncom.CLSCTX_LOCAL_SERVER #creates an exe file
    _reg_clsctx_ = pythoncom.CLSCTX_INPROC_SERVER #creates a dll file
